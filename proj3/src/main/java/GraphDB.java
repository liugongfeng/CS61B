...
public class GraphDB {
    ...
    static class Edge {
        ...
        String name;
        List<Long> vertexes;
        Edge(long id, List<Long> vertexes) {
            this.id = id;
    ...
    public final Map<Long, Edge> edges = new LinkedHashMap<>();
    ...
    long closest(double lon, double lat) {
        ...
        double result = distance(closest.lon, closest.lat, lon, lat);
        for (Vertex v : vertices) {
            double temp = distance(v.lon, v.lat, lon, lat);
            if (temp < result) {
                result = temp;
                closest = v;
            }
